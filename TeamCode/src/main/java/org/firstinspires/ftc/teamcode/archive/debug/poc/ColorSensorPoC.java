...
public class ColorSensorPoC extends LinearOpMode{
    ...
    public void runOpMode() throws InterruptedException {
        ...
        // for controlling the LED on the beaconColor sensor
        boolean bLedOn = true;

        // connect colorSensor to the HT Color Sensor. Make sure to check the name!
        colorSensor = hardwareMap.colorSensor.get("beaconColor sensor");
        ...
        while (opModeIsActive()) {
            ...
            // convert beaconColor data to HSV and store it in hsvValues
            ...
            // Send the beaconColor data back to the DS
